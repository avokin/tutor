...
describe UserWord do
  ...
  describe 'should have related words' do
    before(:each) do
      ...
      @user_word2 = FactoryBot.create(:english_user_word)
      @user_word3 = FactoryBot.create(:english_user_word)
  ...
  describe 'updating Word with relations' do
    describe 'categories' do
      before(:each) do
        word_category = FactoryBot.create(:user_word_category)
      ...
      describe 'categories of another user' do
        it 'should not user categories of another user' do
          ...
          category_of_another_user = FactoryBot.create(:user_category, name: another_category_name, user: another_user)
  ...
  describe 'save_attempt' do
    before(:each) do
      @user_word = FactoryBot.create(:english_user_word, :success_count => 1)
    end
